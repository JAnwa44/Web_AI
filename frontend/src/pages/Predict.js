                    ...
                    <div className="card">
                        <div className="card-body">
                            <form onSubmit={this.CreatModelBotton}>
                                <div className="row">
                                    <div className="col-md-12">
                                        <button type="submit" className="btn btn-lg float-right"style={{backgroundColor:"#A2D9CE"}}>Creat Model</button>
                                        <img 
                                        src="https://www.au-group.com/wordpress/wp-content/uploads/2016/06/creditrisk-450x291.jpg"  class="rounded mx-auto d-block" alt="Responsive image">
                                        </img>
                                    </div>
                                </div>
                            </form>
                            ...
                            <form onSubmit={this.handleSubmit}>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <button type="submit" className="btn btn-lg float-right"style={{backgroundColor:"#A2D9CE"}}>Recommend Price</button>
                                    </div>
                                </div>
                                <br/>
                                <div className="row">
                                    <div className="col-md-12">
                                        <div class="alert alert-info" role="alert">
                                            <h1 className='text-center'>Price : {(this.state.label).toLocaleString()} Bath</h1>
                                        </div>
                                    </div>
                                </div>
                            </form>
