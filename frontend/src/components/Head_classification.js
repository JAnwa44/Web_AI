...
class Head extends React.Component {
    ...
    render(){
        return(
            <nav className="navbar navbar-expand-lg navbar-light d-none d-lg-block" id="templatemo_nav_top" style={{backgroundColor:"#48C9B0"}}>
                <div className="container text-light">
                    <div className="w-100 d-flex justify-content-between">
                        <div>
                            <i className="fa fa-envelope mx-2"></i>
                            <a className="navbar-sm-brand text-light text-decoration-none" href="mailto:info@company.com">mimii_anwa_ohm@company.com</a>
                            <i className="fa fa-phone mx-2"></i>
                            <a className="navbar-sm-brand text-light text-decoration-none" href="tel:010-020-0340">63107114-63118590-63123103</a>
                        </div>
                        <div>
